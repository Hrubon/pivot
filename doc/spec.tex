...
we will use SNMP interfaces on the routers. Basically all dedicated router
hardware provides SNMP metrics (albeit in our experience it usually does it in
a way which is slightly incompatible with every other device in the network). 
